...
export default class SceneApp {
  ...
  constructor(node: HTMLElement | null = null, clock: Clock) {
    // ===== RENDERER, 🖼 CANVAS & 🎬 SCENE =====
    {
      ...
      if (node === null) document.body.appendChild(this.renderer.domElement);
      else node.appendChild(this.renderer.domElement);
    ...
    // ===== 🪄 HELPERS =====
    {
      ...
      this.pointLightHelper = new PointLightHelper(
        this.pointLight,
        undefined,
        "orange",
      );
